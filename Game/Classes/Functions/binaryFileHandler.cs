...
public class binaryFileHandler
{
    ...
    public void Save(string path, string file, string line = null, string[] row = null, string[,] table = null, int bound = -1)
    {
        //Make directory
    ...
    public string LoadLine(string path, string file)
    {
        ...
        if (System.IO.File.Exists(path + file) == false) {
        ...
        using (System.IO.BinaryReader binReader = new System.IO.BinaryReader(System.IO.File.Open(path + file, System.IO.FileMode.Open))) {
            do {
                stringStream += (Char(binReader.ReadInt32));
            } while (!(binReader.PeekChar == null));
        }

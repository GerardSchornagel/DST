	...
	public string FillVariables(string expression)
	{
		...
		foreach (string line in stringMediator) {
			...
			if (stringVariable.Split(Char(58))(0).ToLower == "customer") {
				...
				stringOutput += gamecache.currentCharacterProfile.ReturnValue(stringVariable.Split(Char(58))(1));
			} else if (stringVariable.Split(Char(58))(0).ToLower == "characterstatistics") {
				stringOutput += gamecache.currentCharacterStatistics.ReturnValue(stringVariable.Split(Char(58))(1));
			} else if (stringVariable.Split(Char(58))(0).ToLower == "playerprofile") {
				stringOutput += gamecache.currentPlayerProfile.ReturnValue(stringVariable.Split(Char(58))(1));
			} else if (stringVariable.Split(Char(58))(0).ToLower == "playerstatistics") {
				stringOutput += gamecache.currentPlayerStatistics.ReturnValue(stringVariable.Split(Char(58))(1));
			}

...
{
    private individual[] individualDatabase;
    private individual individualCurrent;
    ...
    public string[] GetCurrentCustomer {
        ...
        get { return new string[] {stringCurrent,individualCurrent.ToStrings[0],individualCurrent.ToStrings[1],individualCurrent.ToStrings[2],individualCurrent.ToStrings[3],individualCurrent.ToStrings[4]}; }
        set {
    ...
    public string ReturnValue(string Ethnic, string SettingRequest)
    {
        foreach (individual guest in individualDatabase) {
            if (guest.Ethnic.ToLower == Ethnic.ToLower) {
